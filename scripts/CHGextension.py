...
class CHGDenoiser(CFGDenoiser):
    ...
    def forward(self, x, sigma, uncond, cond, cond_scale, s_min_uncond, image_cond):
        ...
        if tensor.shape[1] == uncond.shape[1] or skip_uncond:
            ...
            if shared.opts.batch_cond_uncond:
                x_out = self.Chara_iteration(None, x_in, sigma_in, tensor, uncond, cond_scale, image_cond_in, is_edit_model, skip_uncond, make_condition_dict, shared.opts.batch_cond_uncond, batch_size, cond_in=cond_in, x_out = None)
            else:
                x_out = self.Chara_iteration(None, x_in, sigma_in, tensor, uncond, cond_scale, image_cond_in, is_edit_model, skip_uncond, make_condition_dict, shared.opts.batch_cond_uncond, batch_size, cond_in=cond_in, x_out = None)
        else:
            x_out = self.Chara_iteration(None, x_in, sigma_in, tensor, uncond, cond_scale, image_cond_in, is_edit_model, skip_uncond, make_condition_dict, shared.opts.batch_cond_uncond, batch_size, cond_in=None, x_out = None)
    ...
    def Chara_iteration(self, dxs, x_in, sigma_in, tensor, uncond, cond_scale, image_cond_in, is_edit_model, skip_uncond, make_condition_dict, batch_cond_uncond, batch_size, cond_in=None, x_out = None):
